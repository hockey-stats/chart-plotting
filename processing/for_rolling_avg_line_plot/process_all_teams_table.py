...
def main(path, year, window, column):
  ...
  Output will be a csv containing rolling averages for every team in the desired season, on the desired
  column, saved to the data/ directory.
  ...
  and finally concat every dataframe in list to our output, containing the rolling averages for each team,
  by game.
